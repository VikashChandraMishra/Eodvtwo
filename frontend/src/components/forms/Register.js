...
const Register = () => {
    ...
    return (
        <div className="grid grid-cols-1 h-max md:h-screen w-ful">
            <div className="bg-gray-400 py-8 flex flex-col justify-center px-4">
                <Formik
                    initialValues={{
                        username: '',
                        password: '',
                ...
                >
                    <Form className="max-w-[600px] w-full mx-auto rounded-lg bg-gray-900 p-8 px-8">
                        <h2 className='text-lg md:text-3xl dark:text-white font-bold text-center'>REGISTER USER</h2>
                            ...
                            <div className="flex flex-row justify-around">
                                ...
                                <div className="flex flex-col text-gray-400 py-2">
                                    <SelectInput
                                        ...
                                        name="gender"
                                        type="text"
                                        options={["Non-binary", "Male", "Female"]}
                                    />
                                </div>
                            </div>
                            ...
                            <div className="flex flex-row justify-around">
                                ...
                                <div className="flex flex-col text-gray-400 py-2">
                                    <SelectInput
                                        ...
                                        name="designation"
                                        type="text"
                                        options={["employee", "reporting manager"]}
                                    />
                                </div>
                            </div>
